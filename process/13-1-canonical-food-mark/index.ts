...
- 乾麺（そうめん、パスタ等）は「乾」が代表、「ゆで」はバリエーション
...
### 米の場合（重要）
- 「水稲」と「陸稲」は同じグループにまとめる（陸稲はほとんど流通しない）
- 「水稲」が代表、「陸稲」はバリエーション
- **正規化名には「水稲」を含めない**（水稲は普通の稲なので特筆不要）
  - ❌「水稲穀粒」「水稲めし」
  - ✅「お米（穀粒）」「お米（めし）」「玄米」「精白米」
- 例：
  - 「水稲穀粒 玄米」「陸稲穀粒 玄米」→ グループ「玄米」
  - 「水稲めし 精白米」「陸稲めし 精白米」→ グループ「ごはん（精白米）」
